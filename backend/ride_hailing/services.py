...
def calculate_fare(distance, estimated_time, vehicle, pricing_rule, stops=0):
    ...
    # For now, we only have one other vehicle type
    # In the future, we can have more vehicle types with different multipliers
    # if vehicle.type == 'premium':
    #     fare *= pricing_rule.premium_vehicle_multiplier
